...
public class ClassInfoTabPanel extends ClassNodeTabPanel {
    ...
    public ClassInfoTabPanel(ClassNode classNode) {
        ...
        JTextField access = new JTextField(String.valueOf(classNode.getAccess()));
        add(access, "wrap");
        add(new JLabel(LangUtil.i18n("class.info.version")));
        JTextField version = new JTextField(String.valueOf(classNode.getVersion()));
        add(version, "wrap");
        ...
        JTextField superName = new JTextField(classNode.getSuperClass());
        add(superName, "wrap");
        add(new JLabel(LangUtil.i18n("class.info.interfaces")));
        JTextField interfaces = new JTextField(StringUtils.join(classNode.getInterfaces(), ";"));
        add(interfaces, "wrap");
