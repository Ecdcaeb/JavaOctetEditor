...
import cn.enaium.joe.util.config.value.EnableValue;
import cn.enaium.joe.util.config.value.IntegerValue;
import cn.enaium.joe.util.config.value.ModeValue;
import cn.enaium.joe.util.config.value.StringValue;
